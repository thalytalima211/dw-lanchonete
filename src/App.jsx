	...
	return (
		<main className="bg-amber-50 py-7 px-8 min-h-[100vh]">
			...
			<div className="flex flex-row justify-evenly mt-4">
				<input className="border rounded-lg w-100 p-1" type="search" onChange={(e) => setFilter(e.target.value)}></input>
				<button
					className="w-fit  bg-amber-900 hover:bg-amber-950 text-white p-3 rounded-xl"
